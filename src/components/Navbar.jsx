    ...
    >
      ...
      <div className="max-w-[1300px] mx-auto flex justify-between items-center px-4 md:px-12 h-20">
        ...
        >
          ...
          <motion.div
            className="absolute -inset-1 bg-gradient-to-r from-amber-600 to-yellow-600 rounded-lg opacity-0 group-hover:opacity-30 blur transition duration-500"
        ...
        <ul className="hidden md:flex items-center gap-8">
          ...
          >
            <motion.a
              ...
              className="relative inline-flex items-center px-6 py-2 text-sm font-medium text-white bg-gradient-to-r from-amber-600/20 to-yellow-600/20 
                                     border border-amber-500 rounded-xl hover:from-amber-600/30 hover:to-yellow-600/30"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Visit Profiles
              <motion.div className="absolute inset-0 rounded-xl bg-gradient-to-r from-amber-600 to-yellow-600 opacity-0 group-hover:opacity-20 blur transition duration-500" />
            </motion.a>
          </motion.li>
        </ul>
        ...
        <motion.div
          className={`fixed right-0 top-0 w-[300px] h-screen bg-[#030014] z-40 p-8
                              border-l border-amber-500/20 backdrop-blur-lg`}
          initial={{ x: "100%" }}
          animate={{ x: nav ? 0 : "100%" }}
