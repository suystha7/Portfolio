  ...
  return (
    <footer className="relative mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center md:text-left space-y-4">
            <motion.h3
              ...
              className="text-3xl font-bold bg-gradient-to-r from-indigo-400 via-teal-400 to-indigo-400 
      ...
      <motion.div
        ...
        className="h-[2px] w-full bg-gradient-to-r from-transparent via-indigo-500/30 to-transparent"
      />
    </footer>
  );
};
