...
const Footer = () => {
  return (
    <footer className="relative mt-20">
      ...
      {/* Glass background */}
      <div className="absolute inset-0 bg-gradient-to-b from-blue-900/10 to-indigo-900/30 
      ...
      <motion.div
        ...
        className="h-[2px] w-full bg-gradient-to-r from-transparent via-blue-500/30 to-transparent"
      />
    </footer>
  );
};
